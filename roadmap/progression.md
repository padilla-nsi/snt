...
### Chap. 1 - Le réseau Internet

1. Communication entre deux machines
1. Communication entre plusieurs machines
1. Transport d'informations sur le réseau mondial
1. Structure des applications du réseau internet 

|Contenu | Capacité|
|--|--|
|Protocole TCP/IP : paquets, routage des paquets | Distinguer le rôle des protocoles IP et TCP. </br> Caractériser les principes du routage et ses limites. </br> Distinguer la fiabilité de transmission et l’absence de garantie temporelle.|
...
3. Communication entre serveurs et clients
...
1. Des relations entre personnes
...
Cyberviolence|Connaître les dispositions de l’article 222-33-2-2 du code pénal.</br>Connaître les différentes formes de cyberviolence (harcèlement, discrimination, sexting...) et les ressources disponibles pour lutter contre la cyberviolence.

### Données et traitement

1. Structurer les données dans des tables
2. Enregistrer les tables dans des fichiers
3. Traiter les données avec le tableur
4. Faire traiter les données par un programme
...
2. Programmation d'un système embarqué
3. Signaux et numérisation
4. Interface homme machine

|Contenu | Capacité|
|--|--|
Régler les paramètres de confidentialité d’un téléphone pour partager ou non sa position. | Identifier des algorithmes de contrôle des comportements physiques à travers les données des capteurs, l’IHM et les actions des actionneurs dans des systèmes courants.
...
|Contenu | Capacité|
|--|--|
Affectations, variables</br>Séquences</br>Instructions conditionnelles</br>Boucles bornées et non</br>bornées</br>Définitions et appels de fonctions | Écrire et développer des programmes pour répondre à des problèmes et modéliser des phénomènes physiques, économiques et sociaux.