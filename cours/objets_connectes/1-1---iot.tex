...
\setcounter{secnumdepth}{0} % Turns off numbering for sections
    ...
    \geometry{a4paper,tmargin=3cm,bmargin=2cm,lmargin=1cm,rmargin=1cm}\fancyhead[L]{Thème à définir}\fancyhead[L]{\adjustimage{height=1cm, valign=m}{/home/bouscadilla/Documents/Code/nbconvert/template/latex/pdf_solution/papier_eleve_ico_iot}}\fancyhead[C]{\bfseries\MakeUppercase{1-1---iot}}\fancyhead[C]{\bfseries\MakeUppercase{Objets connectés}}\fancyhead[R]{\monthyeardate\today}
...
% \maketitle
    ...
    \hypertarget{chap.-2-les-objets-connectuxe9s}{%
\section{Chap. 2 --- Les objets
connectés}\label{chap.-2-les-objets-connectuxe9s}}

    \hypertarget{architecture-dun-systuxe8me-embarquuxe9}{%
\subsection{2.1 --- Architecture d'un système
embarqué}\label{architecture-dun-systuxe8me-embarquuxe9}}
\begin{eleve}
...
\tightlist
\item
  \textbf{Observe} la carte et \textbf{énumère} les différents
  constituants de la carte \(\texttt{Micro:bit}\).
\item
  \textbf{Indique} le rôle de chacun.
\item
  \textbf{D'après toi}, à quoi sert le composant \emph{Processor}? que
  contient-il ?
\end{enumerate}
        
        \end{eleve}\begin{remarque}
    Un \textbf{système informatique embarqué} à bord d'un satellite, d'une
voiture ou d'un congélateur est un \textbf{ordinateur} comme les autres,
avec son processeur et sa mémoire.

        \end{remarque}
    \begin{figure}
\centering
\includegraphics{res/archi-von-neumann.png}
\caption{légende}
\end{figure}
\begin{retenir}
    \textbf{Capteur} :
...
\textbf{capteurs}\strut
\end{minipage} & \begin{minipage}[b]{0.47\columnwidth}\raggedright
\textbf{actionneurs}\strut
\end{minipage}\tabularnewline
\midrule
\endhead
\begin{minipage}[t]{0.47\columnwidth}\raggedright
capteur de température, pression, vitesse, interrupteur, etc.\strut
\end{minipage} & \begin{minipage}[t]{0.47\columnwidth}\raggedright
vanne, électro-aimant, moteur, vérin, LED, etc.\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.47\columnwidth}\raggedright
\strut
\end{minipage} & \begin{minipage}[t]{0.47\columnwidth}\raggedright
...
\end{longtable}
    ...
    Un régulateur de vitesse dans une voiture est un \textbf{système
...
.
        ...
        \end{retenir}
    \hypertarget{programmation-dun-systuxe8me-embarquuxe9}{%
\subsection{2.2 --- Programmation d'un système
embarqué}\label{programmation-dun-systuxe8me-embarquuxe9}}
\begin{eleve}
