...
\setcounter{secnumdepth}{0} % Turns off numbering for sections
    ...
    \geometry{a4paper,tmargin=3cm,bmargin=2cm,lmargin=1cm,rmargin=1cm}\fancyhead[L]{Thème à définir}\fancyhead[L]{\adjustimage{height=1cm, valign=m}{/home/bouscadilla/Documents/Code/nbconvert/template/latex/pdf_solution/papier_eleve_ico_iot}}\fancyhead[C]{\bfseries\MakeUppercase{test}}\fancyhead[C]{\bfseries\MakeUppercase{Objets connectés}}\fancyhead[R]{\monthyeardate\today}
