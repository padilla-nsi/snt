...
\geometry{a4paper,tmargin=2.5cm,bmargin=1cm,lmargin=1cm,rmargin=1cm}\fancyhead[L]{Thème à définir}\fancyhead[L]{\adjustimage{height=1cm, valign=m}{/home/bouscadilla/Documents/Code/nbconvert/template/latex/pdf_solution/papier_eleve_ico_machine}\ttfamily\scshape Internet}\fancyhead[C]{\bfseries\MakeUppercase{01routage}}\fancyhead[C]{\bfseries\MakeUppercase{Routage - Routing Information Protocol}}\fancyhead[R]{\monthyeardate\today}
...
\newcommand{\myDotfill}[1]{\makebox[#1]{\dotfill}}

\newcommand{\tableRoutage}{
    \begin{minipage}{8cm}
        \begin{tabular}{|cll|}\hline
            \multicolumn{3}{|c|}{exp.\myDotfill{3cm} dest.\myDotfill{3cm}} \\ \hline
            \myDotfill{3cm} & (par --- & D. 0) \\
            \myDotfill{3cm} & (par\myDotfill{3cm} & D\myDotfill{1cm}) \\
            \myDotfill{3cm} & (par\myDotfill{3cm} & D\myDotfill{1cm}) \\
            \myDotfill{3cm} & (par\myDotfill{3cm} & D\myDotfill{1cm}) \\
            \myDotfill{3cm} & (par\myDotfill{3cm} & D\myDotfill{1cm}) \\
            \myDotfill{3cm} & (par\myDotfill{3cm} & D\myDotfill{1cm}) \\
            \myDotfill{3cm} & (par\myDotfill{3cm} & D\myDotfill{1cm}) \\ \hline
        \end{tabular}
    \end{minipage}
}
