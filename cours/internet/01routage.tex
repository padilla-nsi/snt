...
\subsection{1. Mise en place}\label{mise-en-place}}
\begin{retenir}
    \textbf{Étape 1.} Chaque élève pioche une adresse email qui doit rester
\textbf{secrète} (parmi \texttt{eleve\_1@lycee.com},
\texttt{eleve\_2@lycee.com},\ldots{} , \texttt{eleve\_36@lycee.com},
etc.)

        \end{retenir}\begin{retenir}
    \textbf{Étape 2.} Chaque élève prend connaissance de son
\textbf{correspondant} : la personnes à laquelle elle peut écrire.

        \end{retenir}\begin{exemple}
    \begin{itemize}
\tightlist
\item
  Djamel \textsubscript{(eleve2@lycee.com)} -\textgreater{} Ada
  \textsubscript{(eleve\_1@lycee.com)}
\item
  Frédérique \textsubscript{(eleve\_3@lycee.com)} -\textgreater{} Djamel
  \textsubscript{(eleve2@lycee.com)}
\end{itemize}

        \end{exemple}
    \hypertarget{premier-message}{%
\subsection{2. Premier message}\label{premier-message}}
\begin{retenir}
    \textbf{Étape 3.} Chaque élève prend une demi-feuilles de papiers (le
\textbf{mail}) et écrit dessus :

\begin{verbatim}
expéditeur: <mail_secret@@lycee.com>
sujet: Hello
<mon prénom>
\end{verbatim}

        \end{retenir}\begin{retenir}
    \textbf{Étape 4.} Chaque élève envoie son mail: il donne la feuille à
son correspondant.
...
maintenant le nombre de correspondant de chaque élève ?
        ...
        \end{eleve}
    \hypertarget{premiuxe8res-ruxe9ponses}{%
\subsection{3. Premières réponses}\label{premiuxe8res-ruxe9ponses}}
\begin{retenir}
    \textbf{Étape 5.} Chaque élève note sur une demi-feuille personnelle sa
table de routage:

\begin{verbatim}
<son prénom> (par -)
<prénom du correspondant> (par <mail du correspondant>)
\end{verbatim}

        \end{retenir}\begin{eleve}
    Que note Djamel dans sa table de routage ? Et Ada ?
        
        \end{eleve}\begin{retenir}
    \textbf{Étape 6.} Chaque élève envoie à tous ses correspondants une
copie de sa table de routage.

        \end{retenir}\begin{eleve}
    Est ce que les correspondants reçoivent de nouvelles informations ? Si
oui, lesquelles ?
        
        \end{eleve}
    \hypertarget{mise-uxe0-jour-des-tables-de-routage}{%
\subsection{4. Mise à jour des tables de
routage}\label{mise-uxe0-jour-des-tables-de-routage}}
\begin{retenir}
    \textbf{Étape 7.} Lorsqu'un élève reçoit la table de routage d'un de ses
correspondant, il met à jour, si besoin, sa tables de routage :

\begin{itemize}
\item
  il ajoute une ligne pour chaque \textbf{nouveau prénom} et y écrit:

  (par )
\end{itemize}

        \end{retenir}\begin{eleve}
    Q1. Compléter les tables de Djamel et d'Ada.

Q2. Est-ce que la table de Frédérique est modifiée ? Si oui, écrire sa
table.
        
        \end{eleve}\begin{retenir}
    \textbf{Étape 8.} Tant qu'un élève a sa table de routage modifiée par
une mise à jour, on reprend à l'étape 6.

        \end{retenir}\begin{eleve}
    Écrire les tables finales obtenues par Djamel, Ada et Frédérique
lorsqu'il n'y a plus de mail échangés.
