...
## Progression (format cahier de texte)

Chap. 1 Réseaux sociaux

### 1.1 Caractériser les réseaux sociaux

* par groupe, définition d'un réseau social
* liste des réseaux sociaux existants
  * notes : caractéristique à étudier sur les réseaux sociaux

### 1.2 e-réputation et bonnes pratiques

* projection vidéo "myshadow"
* notion d'ombre numérique et données
  * def. identité numérique
* projection vidéo "Le faux voyant"
  * def. e-réputation
